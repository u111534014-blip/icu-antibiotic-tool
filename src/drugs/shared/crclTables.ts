import type { CrClRow } from "../types";
...
export const STANDARD_1G_TABLE: CrClRow[] = [
...
export const STANDARD_2G_TABLE: CrClRow[] = [
...
export const UNASYN_3G_TABLE: CrClRow[] = [
...
export const UNASYN_15_3G_TABLE: CrClRow[] = [
...
export const UNASYN_MDR_AB_TABLE: CrClRow[] = [
...
//
// 標準 3.375 g Q6H 起始
export const TAZO_3375_TABLE: CrClRow[] = [
...
// 標準 4.5 g Q6H 起始
export const TAZO_45_TABLE: CrClRow[] = [
...
export const BROSYM_STANDARD_TABLE: CrClRow[] = [
  { min: 0, dose_mg: 4000, freq: "Q12H" },
];

// CRAB 高劑量替代方案
export const BROSYM_HIGH_TABLE: CrClRow[] = [
