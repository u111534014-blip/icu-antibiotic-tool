...
export const PREP_DATA: Record<string, PrepInfo> = {
  ...
  unasyn: { // Sulampi（Ampicillin/Sulbactam 2:1）
    ...
    finalNote: "IV 緩慢注射或稀釋後輸注 15–30 min；NS/注射用水 45 mg/mL 25℃ 8 hr、4℃ 48 hr；5% 葡萄糖依濃度約 2–4 hr；勿與血液製劑/胺基酸混合",
  },
  tazocin: { // Tapimycin（Piperacillin/Tazobactam）
    ...
    finalNote: "輸注 >30 min；瓶內未用部分：室溫 20–25℃ 24 hr、冰箱 2–8℃ 48 hr；輸液袋：室溫 24 hr、冰箱 1 週；與 aminoglycoside 需分開或 Y 型（含 EDTA 藥瓶）",
  },
  ...
  zavicefta: { // Zavicefta（Ceftazidime/Avibactam）
    ...
    finalNote: "輸注 120 min；調配小瓶應立即使用；稀釋後 ceftazidime 8 mg/mL 可 2–8℃ ≤12 hr 後室溫 ≤4 hr，>8–40 mg/mL 室溫 ≤4 hr",
  },
  teicoplanin: { // Teicod
  ...
  ceftaroline: { // Zinforo（捷復寧，Ceftaroline fosamil）
    ...
    finalNote: "標準劑量輸注 5–60 min；高劑量 600 mg Q8H 輸注 120 min；配製後立即稀釋；稀釋後 6 hr 內使用，2–8℃ 可 12 hr、取出回室溫後 6 hr 內用",
  },
  ...
  vancomycin: { // U-Vanco
    ...
    finalNote: "輸注速率 ≤10 mg/min 且 ≥60 min（防紅人症/低血壓）；回溶液需冷藏，可 14 天；再稀釋後室溫 24 hr、冷藏 96 hr；與 β-lactam 分開並沖管",
  },
