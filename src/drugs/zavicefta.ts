    ...
    sections: [
      ...
      },
      {
        ...
        body:
          ...
          "方式 A｜輸注袋（IV bag）：\n" +
          "  將還原液加入點滴袋稀釋，經 infusion pump 或重力滴注。\n" +
          "  適用大部分情境。\n\n" +
          "方式 B｜針筒幫浦（Syringe pump）：\n" +
          "  將還原液 + 少量稀釋液裝入大號注射針筒（如 50 mL syringe），\n" +
          "  接上 syringe pump 定速推注。\n" +
          "  適用 ICU 限液（fluid restriction）病人——用量少（最少 19 mL），\n" +
          "  比掛一袋 250 mL 點滴節省很多液體量。\n\n" +
          "【配置速查表（仿單）】\n" +
          "▸ 2 g（整支 2.5 g）\n" +
          "  抽取：全量約 12 mL\n" +
          "  IV bag：稀釋至 50–250 mL\n" +
          "  Syringe pump：稀釋至 50 mL\n\n" +
          "▸ 1 g（半支 1.25 g）\n" +
          "  抽取：6 mL\n" +
          "  IV bag：稀釋至 25–125 mL\n" +
          "  Syringe pump：稀釋至 25–50 mL\n\n" +
          "▸ 0.75 g（= 0.94 g 合計）\n" +
          "  抽取：4.5 mL\n" +
          "  IV bag：稀釋至 19–93 mL\n" +
          "  Syringe pump：稀釋至 19–50 mL\n\n" +
          "▸ 其他劑量\n" +
          "  抽取量 = 劑量(mg) ÷ 167.3 mg/mL\n" +
          "  稀釋至最終濃度 8–40 mg/mL\n\n" +
          "【穩定性】\n" +
          "• 濃度 8 mg/mL（最大稀釋）：2–8°C 最長 12 小時，隨後 ≤25°C 最長 4 小時\n" +
          "• 濃度 >8–40 mg/mL：≤25°C 最長 4 小時\n" +
          "• Syringe pump（≥8–40 mg/mL）：≤25°C 最長 6 小時",
      },
      {
        heading: "輸注時間",
        body:
