...
export const PREP_DATA: Record<string, PrepInfo> = {
  ...
  mepem: { // Meropenem
    ...
    diluent: "等張生理食鹽水",
    finalNote: "溶解後立即使用；NS 室溫 ≤6 hr、5℃ ≤24 hr",
  },
  ...
  flomoxef: { // Flumarin（氟黴寧，Flomoxef Sodium，Shionogi）
    ...
    finalNote: "調製後盡快使用；室溫 6 hr、冰箱 2–8℃ 24 hr；IV 大量投與放慢速度防血管痛/靜脈炎",
  },
  ertapenem: { // Ertapenem
    brand: "Ertapenem",
    vial: "乾粉 1 g/Vial",
  ...
  ceftriaxone: { // Cefin（汎生舒復，Ceftriaxone）
    ...
    finalNote: "配製後室溫 6 hr、2–8℃ 24 hr；溶液顏色淡黃至琥珀色不影響效價",
  },
  ...
  cefepime: { // Antifect（Cefepime）
    ...
    finalNote: "室溫 24 hr、冰箱 7 天；勿與 β-lactam 抗生素同溶液混合",
  },
  levofloxacin: { // Cravit
    vial: "點滴瓶 5 mg/mL, 50 mL/瓶（等張黃綠色溶液）",
    reconstitution: "成品溶液，不需回溶",
    diluent: "相容：0.9% 食鹽水、5% 葡萄糖、含 2.5% 葡萄糖林格、非腸道營養劑",
    finalNote: "成品等張溶液；僅供緩慢靜脈輸注，避免快速 IV push",
  },
