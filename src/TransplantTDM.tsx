...
export default function TransplantTDM() {
  ...
  const unsafeEstimate=interaction!=="none"||!trueTrough||!steadyState;
  const note=[
    ...
    `Sampling: ${trueTrough?"reported pre-dose trough":"timing not confirmed"}; ${steadyState?"steady state reported":"steady state not confirmed"}.`,
  ...
  return <div>
    ...
    </div><div style={S.checkRow}><label><input type="checkbox" checked={trueTrough} onChange={e=>setTrueTrough(e.target.checked)}/> 確認為下一劑前 true trough</label><label><input type="checkbox" checked={steadyState} onChange={e=>setSteadyState(e.target.checked)}/> 劑量穩定至少約 48-72 hr</label></div>
...
const S:Record<string,CSSProperties>={
  header:{textAlign:"center",padding:"16px 14px 22px"},kicker:{color:ACCENT,fontWeight:800,fontSize:12,textTransform:"uppercase"},title:{margin:"5px 0",fontSize:26,color:"#0F172A"},subtitle:{margin:0,color:"#64748B",fontSize:14},notice:{background:"#F0FDFA",border:"1px solid #99F6E4",color:"#115E59",padding:14,borderRadius:8,lineHeight:1.65,marginBottom:14},card:{background:"#fff",border:"1px solid #E2E8F0",borderRadius:8,padding:16,marginBottom:14},cardTitle:{fontSize:14,fontWeight:800,color:"#334155",marginBottom:14},grid3:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:12},grid2:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(250px,1fr))",gap:12},field:{minWidth:0},label:{display:"block",fontSize:13,fontWeight:700,color:"#475569",marginBottom:6},hint:{display:"block",fontSize:11,color:"#94A3B8",marginTop:4},input:{width:"100%",boxSizing:"border-box",padding:"10px 12px",border:"1.5px solid #DCE4EE",borderRadius:8,background:"#fff",fontSize:15,color:"#0F172A"},targetBanner:{display:"flex",flexDirection:"column",gap:4,marginTop:14,padding:13,borderRadius:8,background:"#F0FDFA",color:"#0F766E"},checkRow:{display:"flex",flexWrap:"wrap",gap:16,marginTop:12,color:"#475569",fontSize:13},resultGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:10,marginTop:14},result:{display:"flex",flexDirection:"column",gap:5,padding:13,border:"1px solid #CCFBF1",borderRadius:8,background:"#F0FDFA",color:"#0F766E"},info:{padding:12,border:"1px solid #BFDBFE",borderRadius:8,background:"#EFF6FF",color:"#1E40AF",lineHeight:1.6,fontSize:13,marginTop:12},warn:{padding:12,border:"1px solid #FDE68A",borderRadius:8,background:"#FFFBEB",color:"#92400E",lineHeight:1.6,fontSize:13,marginTop:12},danger:{padding:12,border:"1px solid #FCA5A5",borderRadius:8,background:"#FEF2F2",color:"#991B1B",lineHeight:1.6,fontSize:13,marginTop:12},pre:{whiteSpace:"pre-wrap",wordBreak:"break-word",background:"#0F172A",color:"#E2E8F0",padding:14,borderRadius:8,fontSize:12,lineHeight:1.6},copy:{width:"100%",padding:11,border:0,borderRadius:8,background:ACCENT,color:"#fff",fontWeight:800,cursor:"pointer"},note:{background:"#fff",border:"1px solid #E2E8F0",borderRadius:8,marginBottom:12,overflow:"hidden"},summary:{padding:14,fontWeight:800,color:"#334155",cursor:"pointer"},noteBody:{padding:"0 14px 14px"},p:{fontSize:14,color:"#475569",lineHeight:1.7},tableWrap:{overflowX:"auto"},table:{width:"100%",borderCollapse:"collapse",minWidth:620,fontSize:13},th:{textAlign:"left",padding:10,background:"#F8FAFC",color:"#64748B",borderBottom:"1px solid #E2E8F0"},td:{padding:10,color:"#475569",lineHeight:1.55,borderBottom:"1px solid #EEF2F7",verticalAlign:"top"},tdStrong:{padding:10,color:"#0F172A",fontWeight:800,borderBottom:"1px solid #EEF2F7",verticalAlign:"top"},sources:{color:"#94A3B8",fontSize:11,lineHeight:1.6,padding:"8px 4px 20px"}
};
