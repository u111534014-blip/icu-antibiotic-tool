  ...
  indications: [
    ...
    // ═══ 7. Endocarditis ═══
    {
      ...
      scenarios: [
        ...
        {
          label: "VGS / S. gallolyticus, native valve（高度 penicillin 敏感 MIC ≤0.12）",
        ...
        {
          label: "VGS / S. gallolyticus, native valve（relatively/fully penicillin-resistant）",
        ...
        {
          label: "VGS / S. gallolyticus, prosthetic valve（高度 penicillin 敏感）",
        ...
        {
          label: "VGS / S. gallolyticus, prosthetic valve（relatively/fully penicillin-resistant）",
