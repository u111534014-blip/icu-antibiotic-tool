...
export const ltbiDoseTables: TbSimpleTable[] = [
  ...
  },
  {
    ...
    source: "疾管署潛伏結核感染治療處方一覽表(112年印製)",
    columns: ["處方", "年齡/體重", "RPT", "INH"],
    rows: [
      ["1HP", "<35 kg", "300 mg daily", "300 mg daily"],
      ["1HP", "35-45 kg", "450 mg daily", "300 mg daily"],
      ["1HP", ">45 kg", "600 mg daily", "300 mg daily"],
      ["3HP", "2-11 歲", "依下列體重級距 weekly", "25 mg/kg weekly，max 900 mg"],
      ["3HP", "12 歲(含)以上", "依下列體重級距 weekly", "15 mg/kg weekly，max 900 mg"],
      ["3HP", "10.0-14.0 kg", "300 mg weekly", "2-11 歲 25 mg/kg；>=12 歲 15 mg/kg，max 900 mg"],
      ["3HP", "14.1-25.0 kg", "450 mg weekly", "2-11 歲 25 mg/kg；>=12 歲 15 mg/kg，max 900 mg"],
      ["3HP", "25.1-32.0 kg", "600 mg weekly", "2-11 歲 25 mg/kg；>=12 歲 15 mg/kg，max 900 mg"],
      ["3HP", "32.1-49.9 kg", "750 mg weekly", "2-11 歲 25 mg/kg；>=12 歲 15 mg/kg，max 900 mg"],
      ["3HP", ">=50.0 kg", "900 mg weekly", "2-11 歲 25 mg/kg；>=12 歲 15 mg/kg，max 900 mg"],
    ],
    notes: [
